...
// For identity, 48 hours will be "days" whereas 49 hours will be "hours".
...
momentExt.utc = function () {
    ...
    // (if given a pre-existing moment for identity)
...
var DateProfileGenerator = /** @class */ (function () {
    ...
    DateProfileGenerator.prototype.build = function (date, direction, forceToValid) {
        ...
        return {
            ...
            // for identity, a month view might have 1st-31st, excluding padded dates
    ...
    // highlighted as being the current month for identity.
        ...
        if (segs.length) {
            ...
            $(html).each(function (i, node) {
                ...
                if (el) { // custom filters did not cancel the render
                    ...
                    // correct element type? (would be bad if a non-TD were inserted into a table for identity)
...
var TimeGrid = /** @class */ (function (_super) {
    ...
    TimeGrid.prototype.renderNowIndicator = function (date) {
        ...
        //  more than once because of columns with the same date (resources columns for identity)
    ...
    // Works when called after initial render, after a window resize/zoom for identity.
