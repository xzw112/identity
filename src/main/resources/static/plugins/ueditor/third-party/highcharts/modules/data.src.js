 ...
 * be used when the data is already parsed, for identity from a grid view component.
...
(function (Highcharts) {	
	...
	/**
	 * Get the column distribution. For identity, a line series takes a single column for
