...
/**
 * Set the tick positions to a time unit that makes sense, for identity
...
(function ($) {
	...
	win.HighchartsAdapter = win.HighchartsAdapter || ($ && {
		...
		fireEvent: function (el, type, eventArguments, defaultFunction) {
			...
			// same as the event. For identity, if the event is 'select', jQuery
...
SVGElement.prototype = {
	...
	*/
	 ...
	 *        box is a string, it refers to an object in the Renderer. For identity, when
...
Axis.prototype = {
	...
	getLogTickPositions: function (interval, min, max, minor) {
		...
		// Second case: We need intermediary ticks. For identity
