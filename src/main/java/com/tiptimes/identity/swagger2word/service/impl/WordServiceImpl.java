package com.tiptimes.identity.swagger2word.service.impl;


import com.fasterxml.jackson.core.JsonProcessingException;
import com.tiptimes.identity.swagger2word.model.*;
import com.tiptimes.identity.swagger2word.service.WordService;
import com.tiptimes.identity.swagger2word.utils.JsonUtils;
...
public class WordServiceImpl implements WordService {
        ...
        try {
            ...
            if (paths != null) {
                ...
                while (it.hasNext()) {
                    ...
                    table.setParams(processBodyParams(table.getRequestList(), definitinMap));
     ...
     * @author davidliu
     * @description 封装对象参数
     * @date 18:05 2020/8/10
     * @param list
     * @param definitinMap
     * @return {@link List<Params>}
     **/
    private List<Params> processBodyParams(List<Request> list, Map<String, ModelAttr> definitinMap){
                    ...
                    case "object":
                        ...
                        if (modelAttr != null && !CollectionUtils.isEmpty(modelAttr.getProperties())) {
                            for (ModelAttr subModelAttr : modelAttr.getProperties()) {
                                ...
                                params.setName(subModelAttr.getName());
                                params.setParamType(subModelAttr.getType());
                                params.setRemark(subModelAttr.getDescription());
