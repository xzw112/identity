package com.tiptimes.identity.swagger2word.controller;
...
public class WordController {
    ...
    public void word(@RequestParam(required = false) String url, HttpServletRequest request, HttpServletResponse response) {
        ...
        ResponseEntity<String> forEntity = restTemplate.getForEntity(basePath + "/toWord?download=0&url=" + StringUtils.defaultIfBlank(url, swaggerUrl), String.class);
