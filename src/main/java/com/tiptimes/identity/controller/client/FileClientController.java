...
public class FileClientController {
    ...
    public ResponseResult uploadFile(@RequestParam("file") MultipartFile mainfile, HttpServletRequest request){
        //1.后半段目录：  2020/03/15
    ...
    public ResponseResult uploadDFSFile(@RequestParam("file") MultipartFile mainfile) throws IOException {
