...
public class UserDepartmentController {
    ...
    @SystemLog(operateType = OperateTypeConstant.MODIFY, operateDetail = "更新用户所属部门", moduleName = "用户-内部用户")
    ...
    @SystemLog(operateType = OperateTypeConstant.MODIFY, operateDetail = "删除用户所属部门", moduleName = "用户-内部用户")
