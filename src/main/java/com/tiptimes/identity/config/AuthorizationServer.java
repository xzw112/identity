...
import com.tiptimes.identity.component.OAuthUserDetailService;
import com.tiptimes.identity.exception.BootOAuth2WebResponseExceptionTranslator;
...
public class AuthorizationServer extends AuthorizationServerConfigurerAdapter {
    ...
    @Autowired
    private OAuthUserDetailService userDetailsService; // 用户详情
    @Autowired
    ...
    public AuthorizationServerTokenServices tokenServices(){
        ...
        services.setAccessTokenValiditySeconds(-1); // 令牌默认有效期--2小时
        services.setRefreshTokenValiditySeconds(-1); // 刷新令牌默认有效期--3天
        return services;
    }
